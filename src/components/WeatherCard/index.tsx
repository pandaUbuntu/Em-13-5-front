import type { OneDayType } from '../../types/weatherTypes'
import './style.css'


const WeatherCard = (props:OneDayType) =>{
  ...
  return (
      <div className="cardContainer">
        <div className="card">
          ...
          <p className="weather">{props.dayName}</p>
          <svg
            className="weather"
            version="1.1"
            id="Layer_1"
          ...
          <p className="temp">{props.currentTemperature}°</p>
          <div className="minmaxContainer">
            <div className="min">
              <p className="minHeading">Min</p>
              <p className="minTemp">{props.minTemperature}°</p>
            </div>
            <div className="max">
              <p className="maxHeading">Max</p>
              <p className="maxTemp">{props.maxTemperature}°</p>
            </div>
          </div>
        </div>
    </div>
